...
humandate: "Sep 8-17, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2026-09-17        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["James Frew", "Jose Niño Muriel", "Rachel Torres", "Geoffrey Boushey", "David Moles", "Tim Dennis", "Reid Otsuji"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jose Niño Muriel", "Geno Sanchez"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
