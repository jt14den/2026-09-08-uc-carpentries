...
instructor: ["James Frew", "Jose Niño Muriel", "Rachel Torres", "Geoffrey Boushey", "Celeste Allaband", "David Moles", "Tim Dennis", "Reid Otsuji"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jose Niño Muriel", "Geno Sanchez", "Anindya Ganguly", "Kristi Liu"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
